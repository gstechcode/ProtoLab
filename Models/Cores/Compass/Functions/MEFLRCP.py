...
class MEFLRCP(desvio):
	def __init__(self, master):
		self.fdict= master.csv
		self.master= master
		self.load("2u,  MeFL Coronal Plane","2u,, MeFR Coronal Plane","MeFL Coronal Plane","MeFR Coronal Plane","MEFLRCP")
	...
	def response(self):
		if(self.master.fdict["MEFLRCP"]["formula"] == 0):
			return "Corpos mandibulares equidistantes ao Plano Coronal."
		elif(self.master.fdict["MEFLRCP"]["formula"] == 1):
			return "Corpo mandibular Esquerdo mais anterior ao Plano Coronal."
		elif(self.master.fdict["MEFLRCP"]["formula"] == 2):
			return "Corpo mandibular Direito mais anterior ao Plano Coronal."