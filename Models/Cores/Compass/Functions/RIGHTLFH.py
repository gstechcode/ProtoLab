class RIGHTLFH:
	def __init__(self, master):
		...
		self.master= master
		self.load("2bB1 Right Lower Facial Height","Right LFH")
	...
	def response(self):
		if(self.master.fdict["Right LFH"]["formula"] == 0):
			return "LFH é mediano"
		elif(self.master.fdict["Right LFH"]["formula"] == 1):
			return "Ângulo da AFAI diminuído"
		elif(self.master.fdict["Right LFH"]["formula"] == 2):
