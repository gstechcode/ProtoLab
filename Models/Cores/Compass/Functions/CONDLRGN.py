...
class CONDLRGN(desvio):
	def __init__(self, master):
		self.fdict= master.csv
		self.master= master
		self.load("2l CondL - Gn","2m CondR - Gn","CondL - Gn","CondR - Gn","CondLRGN")
	...
	def response(self):
		if(self.master.fdict["CondLRGN"]["formula"] == 0):
			return "Diagonais mandibulares simétricas"
		elif(self.master.fdict["CondLRGN"]["formula"] == 1):
			return "Diagonais mandibulares ligeiramente assimétricas."
		elif(self.master.fdict["CondLRGN"]["formula"] == 2):
			return "Diagonais mandibulares assimétricas."
		else:
			return ""